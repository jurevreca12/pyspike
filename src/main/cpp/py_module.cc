...
PYBIND11_MODULE(_riscv, m) {
  ...
  // riscv.isa_parser
  {
    ...
    py::enum_<isa_extension_t>(mod_isa_parser, "isa_extension_t")
        ...
        .value("zce", isa_extension_t::EXT_ZCE)
        ...
        .value("zvfbfa", isa_extension_t::EXT_ZVFBFA)
        .value("zvfhmin", isa_extension_t::EXT_ZVFHMIN)
        .value("zvfofp4min", isa_extension_t::EXT_ZVFOFP4MIN)
        .value("zvfofp8min", isa_extension_t::EXT_ZVFOFP8MIN)
        .value("smepmp", isa_extension_t::EXT_SMEPMP)
        .value("smstateen", isa_extension_t::EXT_SMSTATEEN)
        .value("smpmpmt", isa_extension_t::EXT_SMPMPMT)
        ...
        .value("svukte", isa_extension_t::EXT_SVUKTE)
        .value("svrsw60t59b", isa_extension_t::EXT_SVRSW60T59B)
        ...
        .value("zvkb", isa_extension_t::EXT_ZVKB)
        ...
        .value("zvqldot8i", isa_extension_t::EXT_ZVQLDOT8I)
        .value("zvqldot16i", isa_extension_t::EXT_ZVQLDOT16I)
        .value("zvfqldot8f", isa_extension_t::EXT_ZVFQLDOT8F)
        .value("zvfwldot16bf", isa_extension_t::EXT_ZVFWLDOT16BF)
